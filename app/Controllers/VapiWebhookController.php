...
public function getAssistantConfig(string $callId, string $gender = 'male'): array
{
    ...
    if ($hasChatHistory) {
        ...
        $firstMessage = ($gender === 'female')
            ? "مرحباً، معِك {$botName} من شركة بي واي دي، بشو بقدر أساعدِك اليوم؟ بتحبي تحجزي موعد بمركز خدمات بي واي دي، أو بتحبي تستفسري عن السيارات الموجودة عنا؟"
            : "مرحباً، معَك {$botName} من شركة بي واي دي، بشو بقدر أساعدَك اليوم؟ بتحب تحجز موعد بمركز خدمات بي واي دي، أو بتحب تستفسر عن السيارات الموجودة عنا؟";
    }
...
الموديلات المعتمدة (بالانجليزي، كما ترجع من get_available_models):
ATTO 2, ATTO 3, SEAL, SEAL U, SEALION 7, DOLPHIN, HAN
...
الرد:
"ATTO Three فيها مواصفات مميزة من ناحية الراحة والتجهيزات. بدك كمان أحكيلك عن المدى أو الشحن؟" 
...
- جاوبي عادي بدون أي إشارة للتصحيح.واستخدمي "ATTO Three" وأنتِ بترديّ صوتياً عليه.

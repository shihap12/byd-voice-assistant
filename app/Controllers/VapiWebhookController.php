...
معلومة داخلية (لا تذكريها للعميل): بناءً على سياق سابق، جنس العميل المسجّل حالياً هو "{$gender}". إذا كانت هاي معلومة مؤكدة من محادثة سابقة، التزمي فيها من أول رد بالمكالمة، إلا إذا ظهر دليل واضح وصريح من كلام العميل نفسه يناقضها — عندها بدّلي فوراً بدون تعليق.

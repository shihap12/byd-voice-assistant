...
$firstMessage = ($gender === 'female')
    ...
    ? "معِك {$botName} من شركة بي واي دي، كيف بِتْحِبي أساعدِك اليوم؟ بِتْحِبي تستفسري عن سياراتنا ولا بِتْحِبي تحجزي موعد لسيارتِك عنا؟"

    : "معَك {$botName} من شركة بي واي دي، كيف بِتْحِبْ  أساعدَك اليوم؟ بِتْحِبْ  تستفسر عن سياراتنا ولا بِتْحِبْ تحجز موعد لسيارتَك عنا؟";

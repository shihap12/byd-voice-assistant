...
$firstMessage = ($gender === 'female')
    ? "سلام عليكم، معِك {$botName} من شركة بي واي دي. إذا عندِك أي استفسار أو ملاحظة أو بدِك تحجزي موعد لزيارة المعرض، أنا جاهزة أساعدِك."
    : "سلام عليكم، معَك {$botName} من شركة بي واي دي. إذا عندَك أي استفسار أو ملاحظة أو بدَك تحجز موعد لزيارة المعرض، أنا جاهزة أساعدَك.";
        }
    } else {
        // رسالة الترحيب القياسية العادية
// رسالة الترحيب القياسية العادية
...
- تاريخ ووقت الآن بالضبط: {$todayDate} الساعة {$currentTime} ({$todayDayNameAr}). **نطقه الجاهز الصحيح (استخدميه حرفياً لو حكيتيه للعميل، ما تحسبيه بنفسك):** "{$todayDateSpoken}" الساعة "{$currentTimeSpoken}".
